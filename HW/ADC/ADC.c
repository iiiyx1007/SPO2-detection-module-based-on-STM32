...
void InitADC(void)
{
//  ConfigTimer3(1999, 71);   //1Mhz，计数到2000为2ms，即500Hz
	ConfigTimer3(999, 71);   //1Mhz，计数到999为1ms，即1MHz
  ConfigADC1();             //配置ADC1
...
* 注    意：
**********************************************************************************************************/
u16 ReadADCBuf(u16* p)
{
  u16 ok = 0;  //将读取成功标志位的值设置为0
